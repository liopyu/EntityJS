...
public final class InitDecl {
    ...
    public static void finalizeFor(Entity e) {
        ...
        var id = e.getUUID();
        var vals = net.liopyu.entityjs.common.util.overrides.data.SavedDataJS.get(sl).getAll(id);
        var types = net.liopyu.entityjs.common.util.overrides.data.SavedDataJS.get(sl).getTypes(id);
