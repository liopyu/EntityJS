...
public class ContextUtils {
     ...
     * values. Argument names come from {@link net.liopyu.entityjs.common.util.overrides.catalog.DynamicOverrideMethodCatalog}
    ...
    public static class FinalRenderContext<T extends LivingEntity & IAnimatableJS> {
        ...
        public FinalRenderContext(GeoEntityRenderer<T> renderer, PoseStack poseStack, T animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
            this.renderer = renderer;
            this.poseStack = poseStack;
            this.entity = animatable;
            this.model = model;
