...
public interface IAnimatableJSCustom extends GeoAnimatable, GeoEntity {
    ...
    default void registerControllers(AnimatableManager.ControllerRegistrar data) {
        for (CustomEntityJSBuilder.AnimationControllerSupplier<?> supplier : getBuilder().animationSuppliers) {
    ...
    default void triggerAnim(@Nullable String controllerName, String animName) {
        ...
        if (entity.level().isClientSide()) {
            ...
            EntityJSPlatform.sendEntityAnimation(entity, controllerName, animName);
        }
    }
    ...
    default <D> void triggerAnim(Entity relatedEntity, long instanceId, @Nullable String controllerName, String animName) {
        if (relatedEntity.level().isClientSide()) {
            ...
            EntityJSPlatform.sendAnimation(relatedEntity, getClass().toString(), instanceId, controllerName, animName);
        }
    }
