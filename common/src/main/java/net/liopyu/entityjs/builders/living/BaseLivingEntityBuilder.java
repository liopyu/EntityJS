...
public abstract class BaseLivingEntityBuilder<T extends LivingEntity & IAnimatableJS> extends BuilderBase<EntityType<T>> {
    ...
    public static final List<BiomeSpawn> biomeSpawnList = new ArrayList<>();
   ...
   /* @RemapForJS("ejs$")
    ...
    public BaseLivingEntityBuilder<T> biomeSpawn(List<String> biomes, int weight, int minCount, int maxCount) {
        List<Either<ResourceLocation, TagKey<Biome>>> biomeList = new ArrayList<>();
        ...
        biomeSpawnList.add(new BiomeSpawn(biomeList, () -> new MobSpawnSettings.SpawnerData(get(), Weight.of(weight), minCount, maxCount)));
        return this;
    }
