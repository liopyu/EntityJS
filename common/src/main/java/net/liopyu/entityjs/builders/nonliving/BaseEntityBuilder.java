...
public abstract class BaseEntityBuilder<T extends Entity & IAnimatableJSNL> extends BuilderBase<EntityType<T>> {
    ...
    public BaseEntityBuilder<T> playStepSound(Consumer<ContextUtils.PlayStepSoundContext> playStepSound) {
    ...
    public BaseEntityBuilder<T> playMuffledStepSound(Consumer<ContextUtils.PlayMuffledStepSoundContext> playMuffledStepSound) {
    ...
    public BaseEntityBuilder<T> playCombinationStepSounds(Consumer<ContextUtils.PlayCombinationStepSoundsContext> playCombinationStepSounds) {
