...
import net.liopyu.entityjs.common.util.overrides.ScriptableCallbackContext;
...
public class ContextUtils {
    ...
    public static class DynamicOverrideContext<T extends Entity> extends ScriptableObject implements ScriptableCallbackContext {
        ...
        private Object jsValue(Context cx, Scriptable scope, Object value) {
            return value == null || value instanceof Scriptable ? value : Context.javaToJS(cx, value, ScriptableObject.getTopLevelScope(scope == null ? this : scope));
        }
        ...
        private Object[] javaArgs(Context cx, Object[] args) {
            ...
            for (int i = 0; i < values.length; i++) {
                converted[i] = Context.jsToJava(cx, values[i], Object.class);
            }
            return converted;
        }
    ...
    public static class VanillaArmorRenderContext<T extends LivingEntity & IAnimatableJS> {
        ...
        public VanillaArmorRenderContext(ItemArmorGeoLayer<T> renderer, PoseStack poseStack, T entity, GeoBone bone,
    ...
    public static class RenderBoneContext<T extends LivingEntity & IAnimatableJS> {
        ...
        public RenderBoneContext(ItemArmorGeoLayer<T> renderer, PoseStack poseStack, T entity, GeoBone bone,
    ...
    public static class ItemBoneRenderContext<T extends LivingEntity & IAnimatableJS> {
        ...
        public ItemBoneRenderContext(BlockAndItemGeoLayer<T> layer, PoseStack poseStack, GeoBone bone, ItemStack item,
                                     T entity, MultiBufferSource bufferSource, float partialTick,
    ...
    public static class ApplyRotationsContext<T extends LivingEntity> {
        ...
        public ApplyRotationsContext(GeoEntityRenderer renderer, T entity, PoseStack poseStack,
    ...
    public static class FinalRenderContext<T extends LivingEntity & IAnimatableJS> {
        ...
        public FinalRenderContext(GeoEntityRenderer<T> renderer, PoseStack poseStack, T entity, BakedGeoModel model,
    ...
    public static class ScaleModelRenderContext<T extends LivingEntity> {
        ...
        public ScaleModelRenderContext(float widthScale, float heightScale, PoseStack poseStack, T entity, BakedGeoModel model, boolean isReRender, float partialTick, int packedLight, int packedOverlay) {
            this(null, widthScale, heightScale, poseStack, entity, model, isReRender, partialTick, packedLight, packedOverlay);
        }

        public ScaleModelRenderContext(GeoEntityRenderer renderer, float widthScale, float heightScale, PoseStack poseStack, T entity, BakedGeoModel model, boolean isReRender, float partialTick, int packedLight, int packedOverlay) {
            this.renderer = renderer;
    ...
    public static class PassengerVehicleContext implements EntityJSCallbackControlContext {
        @Info("The vehicle being considered")
        public final Entity vehicle;

        @Info("The living entity attempting to ride the vehicle")
        public final LivingEntity entity;
    ...
    public static class RenderContext<T extends LivingEntity & IAnimatableJS> {
        ...
        public RenderContext(T entity, float entityYaw, float partialTick,
            ...
            this(null, entity, entityYaw, partialTick, poseStack, bufferSource, packedLight);
        }
