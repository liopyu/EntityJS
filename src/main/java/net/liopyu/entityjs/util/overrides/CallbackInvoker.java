...
public final class CallbackInvoker {
    ...
    private static Object wrapProxyFunctional(Object value) {
        ...
        if (handler instanceof FastFunctionalCallback || !(handler instanceof VMBridge.AdapterInvocationHandler)) {
            return value;
        }
    ...
    private static final class Direct {
        ...
        private static Direct create(Object callback) {
            ...
            if (!(handler instanceof VMBridge.AdapterInvocationHandler adapter) || !(adapter.target() instanceof Callable callable)) {
                return null;
            }
        ...
        private Object invokeObject(Object value) {
            ...
            if (CallbackProfiler.enabled() && method != null) {
                return CallbackProfiler.profileLayer(method, "directConvertObject", () -> cx.jsToJava(result, TypeInfo.OBJECT));
            }
            return cx.jsToJava(result, TypeInfo.OBJECT);
        }
        ...
        private boolean invokeBoolean(Object value) {
            ...
            String method = CallbackProfiler.currentMethod();
            if (CallbackProfiler.enabled() && method != null) {
                return CallbackProfiler.profileLayer(method, "directConvertBoolean", (java.util.function.BooleanSupplier) () -> (boolean) cx.jsToJava(result, TypeInfo.PRIMITIVE_BOOLEAN));
            }
            return (boolean) cx.jsToJava(result, TypeInfo.PRIMITIVE_BOOLEAN);
        }
        ...
        private Object invoke(Method method, Object[] values) {
            ...
            Object converted = cx.jsToJava(result, TypeInfo.of(returnType));
        ...
        private Object wrapArgument(Object value) {
            ...
            if (value instanceof ICallbackWrapperCache cache) {
                ...
                Object wrapped = cx.wrap(topScope, value);
