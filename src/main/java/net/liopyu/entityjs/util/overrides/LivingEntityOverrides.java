...
public final class LivingEntityOverrides {
    ...
    public static <T extends LivingEntity & IAnimatableJS> void onAddedToWorld(T entity, BaseLivingEntityBuilder<T> builder, Runnable fallback) {
        afterSuper(entity, builder == null ? null : builder.onAddedToWorld, "onAddedToWorld", fallback);
    }

    public static <T extends LivingEntity & IAnimatableJS> void onRemovedFromWorld(T entity, BaseLivingEntityBuilder<T> builder, Runnable fallback) {
    ...
    public static <T extends LivingEntity & IAnimatableJS> boolean canCollideWith(T entity, BaseLivingEntityBuilder<T> builder, Entity other, BooleanSupplier fallback) {
        ...
        return booleanOverride(entity, builder.canCollideWith, context, "canCollideWith", fallback);
    }
