...
public final class NonLivingEntityOverrides {
    ...
    public static <T extends Entity> void onAddedToLevel(T entity, BaseNonAnimatableEntityBuilder<?> builder, Runnable fallback) {
        afterSuper(entity, builder == null ? null : builder.onAddedToWorld, "onAddedToWorld", fallback);
    }

    public static <T extends Entity> void onAddedToLevel(T entity, BaseEntityBuilder<?> builder, Runnable fallback) {
        afterSuper(entity, builder == null ? null : builder.onAddedToWorld, "onAddedToWorld", fallback);
    }

    public static <T extends Entity> void onRemovedFromLevel(T entity, BaseNonAnimatableEntityBuilder<?> builder, Runnable fallback) {
        beforeSuper(entity, builder == null ? null : builder.onRemovedFromWorld, "onRemovedFromWorld", fallback);
    }

    public static <T extends Entity> void onRemovedFromLevel(T entity, BaseEntityBuilder<?> builder, Runnable fallback) {
        beforeSuper(entity, builder == null ? null : builder.onRemovedFromWorld, "onRemovedFromWorld", fallback);
    }
    ...
    private static <T extends Entity> boolean booleanOverride(T entity, BooleanCallback<Entity> callback, String fieldName, BooleanSupplier fallback) {
        if (callback == null) {
            return fallback.getAsBoolean();
        }
