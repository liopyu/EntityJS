...
public class ModifyLivingEntityBuilder extends ModifyEntityBuilder {
    ...
    public transient Consumer<ContextUtils.PositionRiderContextMove> positionRider;
    ...
    public ModifyLivingEntityBuilder(EntityType<?> entityType, Entity entity) {
    ...
    @Info(value = """
            @param positionRider A consumer determining the position of rider/riders.
                ...
                ```
            """)
    public ModifyLivingEntityBuilder positionRider(Consumer<ContextUtils.PositionRiderContextMove> builderConsumer) {
