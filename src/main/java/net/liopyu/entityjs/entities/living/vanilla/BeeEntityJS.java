...
public class BeeEntityJS extends Bee implements IAnimatableJS {
    private final BeeJSBuilder builder;
    ...
    public BeeEntityJS(BeeJSBuilder builder, EntityType<? extends Bee> pEntityType, Level pLevel) {
        ...
        for (ContextUtils.PartEntityParams<BeeEntityJS> params : builder.partEntityParamsList) {
    ...
    protected Brain<BeeEntityJS> makeBrain(Dynamic<?> p_21069_) {
        if (EventHandlers.buildBrain.hasListeners()) {
            final Brain<BeeEntityJS> brain = UtilsJS.cast(brainProvider().makeBrain(p_21069_));
        ...
        if (builder.setBreedOffspring != null) {
            ...
            if (obj instanceof ResourceLocation resourceLocation) {
                ...
                if (breedOffspringType != null) {
                    ...
                    if (breedOffspringEntity instanceof Bee b) {
                        return b;
                    }
                }
            }
            EntityJSHelperClass.logErrorMessageOnce("[EntityJS]: Invalid resource location or Entity Type for breedOffspring: " + obj + ". Must return an instance of Bee ResourceLocation. Defaulting to super method: " + entityName());
        }
