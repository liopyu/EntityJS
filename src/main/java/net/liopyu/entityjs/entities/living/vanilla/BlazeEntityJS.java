...
public class BlazeEntityJS extends Blaze implements IAnimatableJS {
    private final BlazeJSBuilder builder;
    ...
    public BlazeEntityJS(BlazeJSBuilder builder, EntityType<? extends Blaze> pEntityType, Level pLevel) {
        ...
        for (ContextUtils.PartEntityParams<BlazeEntityJS> params : builder.partEntityParamsList) {
    ...
    protected Brain.Provider<?> brainProvider() {
        if (EventHandlers.buildBrainProvider.hasListeners()) {
            final BuildBrainProviderEventJS<BlazeEntityJS> event = new BuildBrainProviderEventJS<>();
    ...
    @Override
    protected Brain<BlazeEntityJS> makeBrain(Dynamic<?> p_21069_) {
        if (EventHandlers.buildBrain.hasListeners()) {
            final Brain<BlazeEntityJS> brain = UtilsJS.cast(brainProvider().makeBrain(p_21069_));
