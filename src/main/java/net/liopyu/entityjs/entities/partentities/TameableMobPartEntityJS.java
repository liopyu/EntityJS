...
public class TameableMobPartEntityJS extends PartEntity<TameableMobJS> {
    public final TameableMobJS parentMob;
    public final String name;
    private final EntityDimensions size;
    public float width;
    public float height;

    public TameableMobPartEntityJS(TameableMobJS pParentMob, String pName, float pWidth, float pHeight) {
        super(pParentMob);
